...
<title>Local Information around Pax Place</title>
	...
	<div id="wrapper">
	  ...
	  <?php include('includes/nav.php'); ?>
        <div id="content">
         <div class="blueBox"> 
<h2>Around &amp; about  </h2>
<div onclick="window.location.href='eating_out.php';" class='blueBoxSub'>
  <h3>Eating Out</h3>
<p>Eating out in the local area.</p>
</div>
<div onclick="window.location.href='transport.php';" class='blueBoxSub'>
  <h3>Transport</h3>
<p>Transport links to get to Pax Place.</p>
</div>
  <div onclick="window.location.href='sport_and_Leisure.php';" class='blueBoxSub'>
<h3>Sport & Leisure</h3>
<p>Sport &amp; leisure activities in the local area.</p>
</div>
         </div> </div>
<!-- end #content -->
<div id="footer">
