...
<p> Full details of booking terms and conditions will be sent with booking form .</p>   
   <div style="border:#F00; background:#FFC; color:#F00;"><p>Please fill in all the boxes</p></div>       
        <form action="enquiries_mailform.php" method="post">
          <table bgcolor="#f6f6f6" cellspacing="0" cellpadding="1">
              ...
              <tr>
                ...
                <td><input type="text" name="telep" value=""></td>
              </tr>
              <tr>
                ...
                <td>
                  ...
                  2012                  </p>
                  <p> To Friday
                    <input type="text" name="toDate" value=""> 2012</p></td>
              </tr>
                            <tr>
